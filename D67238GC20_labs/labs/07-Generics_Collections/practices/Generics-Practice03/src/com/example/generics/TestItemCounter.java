    ...
    public static void main(String[] args) {
        ...
        for (DukeTransaction transaction : transactions){
            ...
            if (polos.containsKey(transaction.getProductID())){
                ...
                System.out.println("Producte no reconegut");
            }
            ...
            switch (transaction.getTransactionType()){
                ...
                default:
                    System.out.println("No se reconeix el tipus de transacció");
                    continue;
            }
        ...
        SortShirtByCount sortShirtByCount = new SortShirtByCount();
        SortShirtByDesc sortShirtByDesc = new SortShirtByDesc();

        // Print Results - Sort by Description

        System.out.println("Sort by description");

        Collections.sort(shirtList, sortShirtByDesc);
        ...
        Collections.sort(shirtList, sortShirtByCount);
